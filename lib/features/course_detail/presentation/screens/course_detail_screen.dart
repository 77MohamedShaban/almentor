...
class CourseDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => getIt<CourseDetailCubit>()
        ..initializeVideo(
          course.videoUrl ?? "",
          course.id ?? "",
        ),
      child: Scaffold(
        ...
        body: BlocConsumer<CourseDetailCubit, CourseDetailState>(
          listenWhen: (previous, current) => current is NoInternetState,
          ...
          buildWhen: (previous, current) => current is! NoInternetState,
